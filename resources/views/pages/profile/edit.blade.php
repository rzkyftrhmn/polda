...
@php($hasUploadedPhoto = ! empty($user->photo))

@section('content')
<div class="container-fluid">
    <div class="row g-4 g-xl-5 align-items-stretch">
        <div class="col-xl-4 col-lg-5">
            <div class="card card-bx profile-card m-b30 theme-bg-card theme-border h-100">
                <div class="card-body p-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="d-flex justify-content-between align-items-center py-3 border-top theme-border">
                    ...
                    <div class="mt-4 d-grid gap-3">
                        ...
                        @if($hasUploadedPhoto)
                            <form method="POST" action="{{ route('profile.photo.delete') }}" onsubmit="return confirm('Hapus foto profil saat ini?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-outline-danger w-100">Hapus Foto Profil</button>
                            </form>
                        @endif
                    </div>
                </div>
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="d-flex flex-column gap-4 h-100">
                <div class="card profile-card card-bx theme-bg-card theme-border">
                    ...
                    <form id="profileUpdateForm" class="profile-form" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body p-4">
