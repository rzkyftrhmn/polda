                ...
                <div class="card-body p-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="d-flex justify-content-between align-items-center py-3 border-top border-secondary">
                            ...
                            <span class="text-body">{{ $roleNames->implode(', ') ?: '-' }}</span>
                        </li>
                        <li class="d-flex justify-content-between align-items-center py-3 border-top border-secondary">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card profile-card card-bx m-b30">
                <div class="card-header border-0 pb-0 d-flex flex-wrap align-items-center justify-content-between gap-2">
                    <div>
                        <h4 class="card-title mb-1 text-body-emphasis">Detail Profil</h4>
                ...
                <div class="card-body p-4">
                    <div class="row gy-4 gx-3">
                        <div class="col-md-6">
                            ...
                            <h5 class="text-body mb-0">{{ $user->name }}</h5>
                        </div>
                        <div class="col-md-6">
                            <small class="text-muted d-block">Username</small>
                            <h5 class="text-body mb-0">{{ $user->username ?? '-' }}</h5>
                        </div>
                        <div class="col-md-6">
                            <small class="text-muted d-block">Email</small>
                            <h5 class="text-body mb-0">{{ $user->email }}</h5>
                        </div>
                        <div class="col-md-6">
                            <small class="text-muted d-block">Role</small>
                            <h5 class="text-body mb-0">{{ $roleNames->implode(', ') ?: '-' }}</h5>
                        </div>
                        <div class="col-md-6">
                            <small class="text-muted d-block">Instansi</small>
                            <h5 class="text-body mb-0">{{ optional($user->institution)->name ?? '-' }}</h5>
                        </div>
                        <div class="col-md-6">
                            <small class="text-muted d-block">Divisi</small>
                            <h5 class="text-body mb-0">{{ optional($user->division)->name ?? '-' }}</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card card-bx">
                <div class="card-header border-0 pb-0">
                    <h4 class="card-title text-body-emphasis mb-0">Catatan Aktivitas</h4>
                </div>
                <div class="card-body p-4">
