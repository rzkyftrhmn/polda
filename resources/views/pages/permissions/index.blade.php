...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-sm-6">
                                ...
                                <input type="text" class="form-control mb-xl-0 mb-3"
                                       id="filter_q" placeholder="Search by Permission Name">
                            </div>
            ...
            <div class="mb-4 pb-3">
                <a href="{{ route('permissions.create') }}" class="btn btn-primary btn-sm">Tambah Permission</a>
            </div>
            
            <div class="filter cm-content-box box-primary">
                <div class="content-title SlideToolHeader">
                    <div class="cpa">
                        <i class="fa-solid fa-file-lines me-1"></i>Permission List
                    </div>
                    <div class="tools">
                        <a href="javascript:void(0);" class="expand handle"><i class="fal fa-angle-down"></i></a>
                    </div>
                ...
                <div class="cm-content-body form excerpt">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="permissions-table" class="display min-w850">
                                <thead>
                                    <tr>
                                        <th>No</th>
