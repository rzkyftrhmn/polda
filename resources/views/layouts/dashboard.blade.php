...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/css/theme-fixes.css') }}">
</head>
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route('dashboard.index') }}" class="brand-logo">
				<img src="{{ asset('dashboard/images/poldajabar-bg.png') }}" 
					alt="Logo" 
					class="logo-img">

				<div class="brand-title">
					<img src="{{ asset('dashboard/images/propam-bg.png') }}" 
					alt="Logo" 
					class="logo-img">
				</div>
